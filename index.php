...
<body>
    ...
    <main class=" max-w-[1000px] mx-auto p-20">
        ...
        <section class=" bg-gray-100 p-10 rounded-lg">
            ...
            <form action="./calculator.php" method="post">
                ...
                <div class="flex gap-3 mb-6">
                    ...
                    <label for="amount" class="block text-sm font-medium mb-2 justify-between dark:text-white">Amount:</label>
                    <input type="number" name="amount" id="amount" step="any" required class=" flex-grow  justify-center py-3 px-4 block justify-between border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400 dark:focus:ring-gray-600">

                    <label for="to_currency" class="block text-sm font-medium mb-2 justify-between dark:text-white">To Currency:</label>
                    <select name="to_currency" id="home_breadth" class=" flex-grow  justify-center py-3 px-4 block justify-between border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400 dark:focus:ring-gray-600" required>
                        <?php
                    ...
                    <!-- <label for="home_breadth" class="block text-sm font-medium mb-2 justify-between dark:text-white">Home Breadth</label>
                    <input type="number" name="home_breadth" id="home_breadth" class=" flex-grow  justify-center py-3 px-4 block justify-between border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400 dark:focus:ring-gray-600"> -->
                </div>
